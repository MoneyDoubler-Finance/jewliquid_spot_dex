...
const Config: React.FC<ConfigProps> = ({
  ...
  return createPortal(
    ...
    >
      <div 
        className="relative bg-[#050a0e] border border-[#00ffff40] rounded-lg shadow-lg w-full max-w-md overflow-hidden transform config-cyberpunk-content config-glow"
      ...
      >
        ...
        {/* Header */}
        <div className="relative z-10 p-4 flex justify-between items-center border-b border-[#00ffff40]">
          <div className="flex items-center">
            <div className="w-8 h-8 rounded-full flex items-center justify-center bg-[#00ffff20] mr-3">
              <Settings size={16} className="text-[#00ffff]" />
            </div>
            <h2 className="text-lg font-semibold text-[#e4fbf2] font-mono">
              <span className="text-[#00ffff]">/</span> SYSTEM CONFIG <span className="text-[#00ffff]">/</span>
            </h2>
          </div>
          <button 
            onClick={onClose}
            className="text-[#7ddfff] hover:text-[#00ffff] transition-colors p-1 hover:bg-[#00ffff20] rounded"
          >
            <X size={18} />
          </button>
        </div>
        ...
        <div className="relative z-10 p-5 space-y-5">
          <div className="group animate-[fadeIn_0.3s_ease]">
            <div className="flex items-center gap-1 mb-2">
              <label className="text-sm font-medium text-[#7ddfff] group-hover:text-[#00ffff] transition-colors duration-200 font-mono uppercase tracking-wider">
                <span className="text-[#00ffff]">&#62;</span> RPC Endpoint URL <span className="text-[#00ffff]">&#60;</span>
              </label>
              <Server size={14} className="text-[#7ddfff]" />
            </div>
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-2.5 bg-[#091217] border border-[#00ffff30] rounded-lg text-[#e4fbf2] shadow-inner focus:border-[#00ffff] focus:ring-1 focus:ring-[#00ffff50] focus:outline-none transition-all duration-200 config-input-cyberpunk font-mono tracking-wider"
                placeholder="ENTER RPC ENDPOINT URL"
              />
              <div className="absolute inset-0 rounded-lg pointer-events-none border border-transparent group-hover:border-[#00ffff30] transition-all duration-300"></div>
            </div>
          </div>
          ...
          <div className="group animate-[fadeIn_0.35s_ease]">
            <div className="flex items-center gap-1 mb-2">
              <label className="text-sm font-medium text-[#7ddfff] group-hover:text-[#00ffff] transition-colors duration-200 font-mono uppercase tracking-wider">
                <span className="text-[#00ffff]">&#62;</span> API Key <span className="text-[#00ffff]">&#60;</span>
              </label>
              <Key size={14} className="text-[#7ddfff]" />
            </div>
            <div className="relative">
              <input
                type="text"
          ...
          <div className="group animate-[fadeIn_0.4s_ease]">
            <div className="flex items-center gap-1 mb-2">
              <label className="text-sm font-medium text-[#7ddfff] group-hover:text-[#00ffff] transition-colors duration-200 font-mono uppercase tracking-wider">
                <span className="text-[#00ffff]">&#62;</span> Transaction Fee (SOL) <span className="text-[#00ffff]">&#60;</span>
              </label>
              <CreditCard size={14} className="text-[#7ddfff]" />
            </div>
            <div className="relative">
              <input
                type="number"
          ...
          <div className="pt-4 animate-[fadeIn_0.5s_ease]">
            <button
              onClick={onSave}
              className="w-full px-5 py-3 bg-[#00ffff] text-[#050a0e] rounded-lg shadow-lg transition-all duration-300 font-mono tracking-wider font-medium transform hover:-translate-y-0.5 hover:bg-[#00cccc] config-btn-cyberpunk"
            >
              SAVE CONFIGURATION
            </button>
          </div>
        ...
        <div className="absolute top-0 left-0 w-4 h-4 border-t-2 border-l-2 border-[#00ffff] opacity-70"></div>
        <div className="absolute top-0 right-0 w-4 h-4 border-t-2 border-r-2 border-[#00ffff] opacity-70"></div>
        <div className="absolute bottom-0 left-0 w-4 h-4 border-b-2 border-l-2 border-[#00ffff] opacity-70"></div>
        <div className="absolute bottom-0 right-0 w-4 h-4 border-b-2 border-r-2 border-[#00ffff] opacity-70"></div>
      </div>
    </div>,
    document.body
  );
